...
# Load a cover image
cover_image_path = r'G:\Sem 3\Mini Project\sample.png'

#Calculate and Print the Maximum Capacity available in the image
Cap = Capacity.calculate_max_capacity(cover_image_path)
print("Maximum capacity:", Cap, "bits\n")

# Data to embed
user_input = input("Enter a string: ")
data_to_hide = user_input + "\n"

# Embed data
stego_image = encode_lsb(cover_image_path, data_to_hide)

# Extract data
extracted_data = decode_lsb(stego_image)
# Compare extracted data with the original data
if data_to_hide == extracted_data:
...
PSNR=ImageQuality.calculate_psnr(cover_image_path,stego_image)
SSIM=ImageQuality.calculate_ssim(cover_image_path,stego_image)
